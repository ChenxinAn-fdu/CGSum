            ...
            for idx, line in enumerate(f, start_idx):
                try:
                    ...
                    if error == 'ignore':
                        ...
                        logging_wraper.error("Error occurred at the {} line.".format(idx))
                        raise e
            total_hits = sum(hit_flags)
            logging_wraper.info("Found {} out of {} words in the pre-training embedding.".format(total_hits, len(vocab)))
